...
console.error('Invalid fullname response:', response);
  ...
  handleConfirmBooking = () => {
    const { patientName, phoneNumber, selectedSlot, selectedDate } = this.state;
  ...
  render() {
    const { fullname, selectedSlot, selectedDate, showModal, patientName, phoneNumber } = this.state;
      ...
      <div className='page-container'>
        ...
        <div className='body-container'>
          <div className='left-panel'>
            <h2 className='section-title'>NEUROLOGICAL DISEASES</h2>
        ...
        {showModal && (
          <div className='modal-overlay'>
            <div className='modal-content'>
              ...
              <label>Disease:</label>
              <input type='text' value='Neurological' readOnly />
